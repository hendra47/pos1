<nav class="navbar navbar-light navbar-static-top navbar-custom">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                <li {{ in_array(Request::segment(1), ['drafts','home']) ? 'class=active' : '' }}>
                    {{ link_to_route('cart.index', trans('nav_menu.draft_list'), [], ['class' => 'text-black']) }}
                </li>
                <li {{ (Request::segment(1) == 'transactions') ? 'class=active' : '' }}>
                    {{ link_to_route('transactions.index', trans('transaction.list'), [], ['class' => 'text-black']) }}
                </li>
                <li {{ (Request::segment(1) == 'reports') ? 'class=active' : '' }}>
                    {{ link_to_route('reports.sales.index', trans('report.sales'), [], ['class' => 'text-black']) }}
                </li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle text-black" data-toggle="dropdown" role="button" aria-expanded="false">
